...
download.file(url, destfile = "extdata/base-cc-tourisme-2019-geo2019.zip", method = "auto")
...
enq_tourisme <- read_excel("extdata/base-cc-tourisme-2019-geo2019.xls", 
                           sheet = "COM", skip = 5, n_max = 50)
datatable(head(enq_tourisme), options = list(dom = 't'))
```
### Exemple données sur les logements vacants depuis data.gouv.fr
```{r}
...
url <- "https://static.data.gouv.fr/resources/logements-vacants-du-parc-prive-par-anciennete-de-vacance-par-commune-et-par-epci/20220513-194528/logements-vacants-du-parc-prive-par-epci-au-01012020-lovac-.xlsx"

download.file(url, destfile = "extdata/logements-vacants-du-parc-prive-par-epci-au-01012020-lovac-.xlsx", mode = "wb")
lgt_vac_prv <- read_xlsx("extdata/logements-vacants-du-parc-prive-par-epci-au-01012020-lovac-.xlsx", sheet = 1)
...
Carte_com_Mayotte <- st_read(dsn = "extdata/refgeo", layer = "com_mayotte")
plot(Carte_com_Mayotte)

communes2017 <- st_read(dsn = "extdata/refgeo/communes2017.geojson")
plot(communes2017)
```
...
```{r lire_3b, eval = TRUE, message = TRUE, warning = FALSE}
