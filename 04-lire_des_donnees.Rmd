...
Un package, encore expérimental, de la DREAL Pays de la Loire, [{datalibaba}](https://dreal-pdl.gitlab-pages.din.developpement-durable.gouv.fr/csd/datalibaba) simplifie l'écriture des instructions de lecture/écriture de données vers ou depuis un SGBD Postgresql/postgis. 
