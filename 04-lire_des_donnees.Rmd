...
download.file(url, destfile = "extdata/SEQUOIA_TRIM_REGION.zip", method = "auto")
unzip(zipfile = "extdata/SEQUOIA_TRIM_REGION.zip", exdir = "extdata")
SEQUOIA <- read_excel("extdata/SEQUOIA_TRIM_REGION_BRUT210610.xlsx", sheet = "PAYS_DE_LA_LOIRE")
datatable(SEQUOIA)
```
...
Carte_EPCI_France <- st_read(dsn = "extdata/refgeo2017", layer = "Contour_epci_2017_region")
plot(Carte_EPCI_France)

communes2017 <- st_read(dsn = "extdata/refgeo2017/communes2017.geojson")
plot(communes2017)
```
...
A noter que `{sf}` étant complètement compatible avec les packages du `tidyverse`, la géométrie se conçoit comme une donnée comme une autre, sur laquelle par exemple on peut réaliser des aggrégations.
